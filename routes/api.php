...
Route::prefix('v1/perfil')->middleware(['auth:sanctum', UpdateTokenExpiration::class])->group(function () {
    ...
    Route::post('/cambiar-foto', [PerfilController::class, 'cambiarFoto']);
    Route::put('/biografia', [PerfilController::class, 'actualizarBiografia']);
    Route::put('/estudiante-datos', [PerfilController::class, 'actualizarDatosEstudiante']);
});
...
Route::middleware(['auth:sanctum', AuditMiddleware::class, UpdateTokenExpiration::class])->group(function () {
    ...
    Route::post('calificaciones/bulk-update-materia', [CalificacionesController::class, 'bulkUpdateMateria'])->middleware([CheckAbilities::class . ':CREADOR,DIRECTOR(A)_ACADÉMICO(A),SECRETARIO(A),DOCENTE']); //QUITAR ADMINISTRADOR AYUDA LCCH
    ...
    Route::get('/estudiantesifas/{id}', [EstudiantesifasController::class, 'show'])->middleware([CheckAbilities::class . ':CREADOR,TÉCNICO,RECTOR(A),DIRECTOR(A)_ACADÉMICO(A),SECRETARIO(A),ADMINISTRADOR(A),INSCRIPCIÓN_GESTIÓN_ACADÉMICA,ASIGNADOR_DE_MATERIAS_ESTUDIANTES,INSCRIPCIÓN_DE_TALLERES,PRACTICANTE,DOCENTE']);
    ...
    Route::post('/plandeestudios/clonar-gestion', [PlandeestudiosController::class, 'cloneGestion'])->middleware([CheckAbilities::class . ':CREADOR,DIRECTOR(A)_ACADÉMICO(A),SECRETARIO(A)']);
    ...
    Route::get('/califhistorias/historial-unificado', [CalifhistoriasConsultaController::class, 'historialUnificado'])->middleware([CheckAbilities::class . ':CREADOR,TÉCNICO,RECTOR(A),DIRECTOR(A)_ACADÉMICO(A),SECRETARIO(A),ADMINISTRADOR(A),PRACTICANTE,OTRO(A),DOCENTE']);
