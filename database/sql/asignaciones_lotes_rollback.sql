-- Tablas para registrar acciones en lote y permitir rollback
-- Basado en la migración: 2026_02_10_000000_create_asignaciones_lotes_tables.php

-- Recomendación: usar InnoDB + utf8mb4
...
CREATE TABLE IF NOT EXISTS `asignaciones_lote_items` (
  ...
  -- Si quieres FK (opcional), descomenta y ajusta si tus tablas/ids coinciden:
  -- ,CONSTRAINT `fk_asig_items_lote_uuid` FOREIGN KEY (`lote_uuid`) REFERENCES `asignaciones_lotes` (`uuid`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
